...
import org.jasonq.service.crawler.core.repository.GeogVillageRepository;
...
public class AsyncCrawlerCompanyTask {
    ...
    @Resource
    private GeogVillageRepository geogVillageRepository;
    @Resource
...
//    @Scheduled(fixedDelay = 20 * 1000)
    public void run() {
        ...
        try {
            GeogVillagePo geogVillagePo = geogVillageRepository.poll();
